...
public class EasyExcelUtil {
     ...
     */
    public static List<Object> readExcelWithModel(InputStream in, Class<? extends BaseRowModel> clazz) throws IOException {
        ...
        if (excelTypeEnum != null) {
            ExcelReader excelReader = new ExcelReader(in, excelTypeEnum, null, listener);
            //默认只有一列表头
